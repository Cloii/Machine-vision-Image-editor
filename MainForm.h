...
namespace proj1 {
    ...
    private:
        ...
        System::Windows::Forms::Button^ btnManualMatrix;
...
#pragma region Windows Form Designer generated code
           void InitializeComponent(void)
           {
               ...
               this->btnManualMatrix = (gcnew System::Windows::Forms::Button());
               ...
               this->btnRotate90CW->Text = L"Rotate ";
               ...
               this->btnFlipHorizontal->Text = L"Mirror";
               ...
               this->panelConvolution->Controls->Add(this->btnManualMatrix);
               ...
               // btnManualMatrix
               // 
               this->btnManualMatrix->Location = System::Drawing::Point(168, 48);
               this->btnManualMatrix->Name = L"btnManualMatrix";
               this->btnManualMatrix->Size = System::Drawing::Size(75, 23);
               this->btnManualMatrix->TabIndex = 5;
               this->btnManualMatrix->Text = L"Manual Math";
               this->btnManualMatrix->UseVisualStyleBackColor = true;
               this->btnManualMatrix->Click += gcnew System::EventHandler(this, &MainForm::btnManualMatrix_Click);
               // 
               // button7
               // 
...
#pragma endregion
    ...
    private: System::Void panelRGB_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {
           ...
           System::Void btnManualMatrix_Click(System::Object^ sender, System::EventArgs^ e) {
               if (pictureBox2->Image == nullptr) return;

               // Create a custom dialog for 3x3 kernel input
               Form^ inputForm = gcnew Form();
               inputForm->Text = "Enter 3x3 Kernel Values";
               inputForm->Size = Drawing::Size(250, 200);
               inputForm->FormBorderStyle = System::Windows::Forms::FormBorderStyle::FixedDialog;
               inputForm->MaximizeBox = false;
               inputForm->MinimizeBox = false;
               inputForm->StartPosition = FormStartPosition::CenterParent;

               // Create DataGridView for 3x3 table
               DataGridView^ grid = gcnew DataGridView();
               grid->Size = Drawing::Size(180, 90);
               grid->Location = Drawing::Point(20, 20);
               grid->ColumnCount = 3;
               grid->RowCount = 3; // Sets exactly 3 rows
               ...
               // Explicitly add rows to ensure they are initialized
               for (int i = 0; i < 3; i++) {
                   grid->Rows->Add(); // Add a row
               }

               // Initialize grid cells with default values (0)
               for (int i = 0; i < 3; i++) {
                   for (int j = 0; j < 3; j++) {
               ...
               okButton->Text = "OK";
               okButton->Location = Drawing::Point(50, 120);
               okButton->DialogResult = System::Windows::Forms::DialogResult::OK;

               Button^ cancelButton = gcnew Button();
               cancelButton->Text = "Cancel";
               cancelButton->Location = Drawing::Point(130, 120);
               ...
               if (inputForm->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
                   ...
                   for (int i = 0; i < 3; i++) {
                       for (int j = 0; j < 3; j++) {
                           String^ value = safe_cast<String^>(grid->Rows[i]->Cells[j]->Value);
                           if (String::IsNullOrEmpty(value) || !float::TryParse(value, kernelData[i * 3 + j])) {
                               MessageBox::Show("Invalid kernel value at [" + i + "," + j + "]. Please enter numeric values.",
